...
* CS 362 
* Assignment 3  
* Random Testing the Smithy Card Function
*/
...
int main (int argc, char* argv[]) 
{
	...
	{	
		...
		// Put the Smithy Card to hand 
		game->hand[player][cardPositions] = smithy;
		...
		// Use the Smithy Card 
		cardEffect(smithy, 0, 0, 0, game, cardPositions, 0);
		
		// Check if we got the right hand counts 
		if (game->handCount[player] == (handCounts + 1))
		{
		...
		if (game->deckCount[player] == (deckCounts - 5))
		{
